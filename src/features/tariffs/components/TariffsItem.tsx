...
export default function TariffsItem({ option, isChecked, handleTariffSelect }: TariffsItemProps) {
  ...
  return (
    ...
    >
      ...
      `}
        >
          ...
          <div className=" flex flex-col min-w-[130px] sm:min-w-[140px] xl:min-w-[200px] ">
            <h2
              className={`mb-[12px] sm:mb-[16px] text-center text-[16px] sm:text-[18px] xl:text-[26px] text-[var(--foreground)] font-medium leading-[1.2]
      ...
      ${option.is_best ? 'text-[var(--attention)]' : 'block w-full text-center text-[var(--foreground)]'}
    `}
