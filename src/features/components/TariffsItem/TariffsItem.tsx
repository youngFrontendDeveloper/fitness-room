  ...
  return (
    ...
    >
      <div className=" flex flex-col min-w-[107px] sm:min-w-[121px] xl:min-w-[178px] ">
        ...
        <span className="text-[var(--attention)] text-[30px] sm:text-[34px] xl:text-[50px] font-semibold leading-[1]">
          {price} ₽
        </span>
        <span className="text-[var(--full-price)] text-[14px] sm:text-[16px] xl:text-[24px] line-through text-right leading-[1.2]">
          {full_price} ₽
        </span>
      </div>
      ...
      {period === 'Навсегда' ? (
        ...
        <p className="block mb-[12px] sm:mb-[16px] text-[14px] xl:text-[16px] text-[var(--foreground)] leading-[1.3]">
          {text}
        </p>
      )}
    </div>
